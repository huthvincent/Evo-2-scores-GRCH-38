...
out["gene_case"] = {"gene": "APOE", "rows": q(
    "SELECT CHR, BP, evo7b_noRC_delta_score d7, evo40b_noRC_delta_score d40, "
    "ExonicFunc_ensGene ef, Func_ensGene fc FROM variants "
    "WHERE CHR='19' AND BP BETWEEN 44880000 AND 44950000 AND evo40b_noRC_delta_score IS NOT NULL ORDER BY BP")}
...
print("APOE-locus variants:", len(out["gene_case"]["rows"]))
